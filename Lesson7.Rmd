...
## Compute the RMSE between your predicted and the original VCF

## Compute the RMSE between your predicted and the original VCF for the 3 classes in the TraininPolygon