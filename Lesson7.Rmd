...
####2.2 Create a model and show a summary of the model object
...
####2.3 Plot the predicted tree cover raster and compare it with the original
...
```{r compareVCF, message=FALSE, include=TRUE}
# Comparing predicted and original VCF
opar<- par(mfrow=c(1,2)) # allow to plots side by side
